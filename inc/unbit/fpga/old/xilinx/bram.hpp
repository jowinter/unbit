 ...
 * @brief Block RAMs
 */
#ifndef UNBIT_OLD_XILINX_BRAM_HPP_
#define UNBIT_OLD_XILINX_BRAM_HPP_ 1
...
namespace unbit
{
	namespace old
	{
		namespace xilinx
		{
			//------------------------------------------------------------------------------------------
			/**
			* @brief Well-known categories of block RAMs.
			*/
			...
			//------------------------------------------------------------------------------------------
			/**
			* @brief Description of a block RAM in a Xilinx FPGA
			*/
			class bram
			{
			protected:
				...
				*/
				...
				/**
				* @brief Bit-offset of the first bit of the BRAM in the configuration frame data found
				*   in the bitstream.
				*
			...
			protected:
				...
				*   configuration frame data in the bitstream and the first bit related to the block
				*   RAM.
				*
			...
			public:
				...
				*
				* @param[in] is_parity indicates whether a data bit (false) or a parity bit (true) is to be
				*  mapped.
				*
				* @return The bitstream offset of the given RAM bit. The returned offset is a
				*  bit-address relative to the start of the configuration frame of the bitstream. (An
				*  address relative to the RAM can be computed by subtracting the bitstream offset of
				*  this RAM itself).
				*
			...
			protected:
				...
				*/
				size_t map_via_table(size_t bit_addr, const uint32_t* map_table,
			...
			*/
			...
			//------------------------------------------------------------------------------------------
			/**
			* @brief Description of a RAMB36E1 block RAM tile (found on 7-series)
			*/
			...
			//------------------------------------------------------------------------------------------
			/**
			* @brief Description of a RAMB36E2 block RAM tile (found on Virtex UltraScale+)
			*/
			class ramb36e2 final : public bram
			{
			public:
				/**
				* @brief Construct a RAMB36E2 block RAM tile.
				*/
			...
			//------------------------------------------------------------------------------------------
			/**
			* @brief Description of a RAMB18E1 block RAM tile (found on 7-series)
			*/
...
#endif // UNBIT_OLD_XILINX_BRAM_HPP_
